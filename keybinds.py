import keyboard 
from auto import safe_click_all_buildings, safe_click, buyall_pos, load_research_template, safe, menu, buyall_merc_pos, settings_pos
from auto import research_template_pos, confirm_template, exca_pos, load_merc_template, exca
...
keyboard.add_hotkey('x', lambda: safe(exca)         )

keyboard.add_hotkey('f1', lambda: safe(load_merc_template))
...
keyboard.add_hotkey('b', lambda: safe_click(*settings_pos))
